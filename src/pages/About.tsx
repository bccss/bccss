                    ...
                    {eBoardMembers.map((member, index) => (
                        ...
                        >
                            <div className="relative mb-4 sm:mb-6">
                                ...
                                <div className="relative w-20 h-20 sm:w-24 sm:h-24 mx-auto rounded-full overflow-hidden border-2 border-surface-border">
                                    <img 
                                        src={member.image} 
                            ...
                            <h4 className="text-base sm:text-lg font-header font-semibold text-text-white mb-1 sm:mb-2">
                                {member.name}
                            </h4>
                            <p className="text-xs sm:text-sm text-primary-green font-medium mb-3 sm:mb-4">
                                {member.title}
                            </p>
                            ...
                            <div className="flex justify-center space-x-3 sm:space-x-4">
                                <a
                                    ...
                                    className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-surface-gray hover:bg-primary-teal/20 flex items-center justify-center transition-all duration-300 hover:scale-110 group/link"
                                    aria-label={`${member.name}'s LinkedIn`}
                                >
                                    <svg className="w-4 h-4 sm:w-5 sm:h-5 text-text-gray group-hover/link:text-primary-teal transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-surface-gray hover:bg-primary-green/20 flex items-center justify-center transition-all duration-300 hover:scale-110 group/link"
                                    aria-label={`${member.name}'s GitHub`}
                                >
                                    <svg className="w-4 h-4 sm:w-5 sm:h-5 text-text-gray group-hover/link:text-primary-green transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
