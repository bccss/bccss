    ...
    <div className="min-h-screen bg-font-gray p-2 sm:p-4 lg:p-8 flex flex-col">
      <div className="p-8 sm:p-4 lg:p-8 max-w-6xl mx-auto w-full flex-grow">
        ...
        <div className="border-2 border-gray-600 rounded shadow-lg overflow-hidden">
          ...
          <div className="p-4 sm:p-6 lg:p-12 font-mono text-primary-green bg-background-black min-h-[70vh] sm:min-h-[75vh] lg:min-h-[85vh] shadow-inner">
            {/* prompt line */}
            <div className="mb-4 text-xs sm:text-sm lg:text-xl xl:text-2xl">
            ...
            {/* welcome text */}
            <pre className="whitespace-pre-wrap text-sm sm:text-base lg:text-2xl xl:text-3xl font-bold">
              {text}
            ...
            {typingComplete && (
              <div className="mt-8 space-y-3 lg:space-y-4">
                {links.map((link, index) => (
                  <div 
                    key={index} 
                    className="group hover:bg-green-400/10 rounded transition-colors duration-200"
                  >
                    <Link 
                      to={link.path} 
                      className="block p-2 lg:p-3 text-xs sm:text-sm lg:text-xl xl:text-2xl"
                    >
                      <span className="text-blue-400">user@bccss</span>
                      <span className="text-font-gray">:</span>
                      <span className="text-blue-300">~</span>
